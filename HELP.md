...
* The original package name 'com.project.spring-batch' is invalid and this project uses 'com.project.spring_batch' instead.
...
```
$ docker run --rm spring-batch:0.0.1-SNAPSHOT
```
...
```
$ build/native/nativeCompile/spring-batch
```
